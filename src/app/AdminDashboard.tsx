...
export default function AdminDashboard({ workers, jobs, workLogs }: AdminDashboardProps) {
  const [activeSubTab, setActiveSubTab] = useState<"logs" | "jobs" | "workers">("logs");
  ...
  return (
    <div className="flex-1 w-full max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      ...
      {toast && (
        <div
          className={`fixed bottom-5 right-5 z-50 flex flex-col gap-2 p-5 rounded-2xl border shadow-2xl transition-all duration-300 animate-slide-in max-w-md ${
            toast.type === "success"
      ...
      <div className="border-b border-zinc-900 mb-8">
                      ...
                      <tr key={log.id} className="text-sm hover:bg-zinc-800/10 transition-colors">
                        ...
                        <td className="py-4 px-4 text-right whitespace-nowrap">
                          <button
                            ...
                            disabled={isPending}
                            className="p-1.5 rounded-lg text-rose-400 hover:text-rose-300 bg-rose-500/5 hover:bg-rose-500/10 border border-rose-500/20 hover:border-rose-500/30 active:scale-95 transition-all disabled:opacity-40"
                          >
                            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="bg-zinc-900/30 border border-zinc-800/80 rounded-2xl p-6 backdrop-blur-sm shadow-xl lg:col-span-1">
            ...
            <form onSubmit={handleAddJob} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={isPending}
                className="w-full bg-gradient-to-r from-teal-500 to-indigo-600 hover:from-teal-400 hover:to-indigo-500 text-white font-semibold py-3 px-4 rounded-xl shadow-lg active:scale-95 transition-all text-sm disabled:opacity-50"
              >
                Create Job
              </button>
            </form>
                      ...
                      <>
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="p-1.5 rounded-lg text-zinc-400 hover:text-zinc-300 bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 active:scale-95 transition-all"
                          >
                            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <>
                        ...
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="p-1.5 rounded-lg text-zinc-400 hover:text-zinc-300 bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 hover:border-zinc-600 active:scale-95 transition-all"
                          >
                            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                            </svg>
